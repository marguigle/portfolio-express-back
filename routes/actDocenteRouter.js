...
actDocenteRouter.get(`${BASE_ROUTE}/:id`, actDocenteController.getOneActDocente);
actDocenteRouter.post(BASE_ROUTE, actDocenteController.createActDocente);
actDocenteRouter.put(`${BASE_ROUTE}/:id`, actDocenteController.updateActDocente);
actDocenteRouter.delete(`${BASE_ROUTE}/:id`, actDocenteController.deleteActDocente);
